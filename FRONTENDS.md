...
src/
  ...
  frontends/
    classic/      the original white-background grid portfolio (route "/legacy").
                  A plain-React frontend — no engine.
    psp/          the PSP cross-media-bar (the default route "/"). Built on the
                  engine.
```
