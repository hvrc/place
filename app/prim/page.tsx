...
import { MazeCanvas, PrimsOrganism, Worm } from "@/app/prim/organism";
...
const PrimPage = () => {
    ...
    useEffect(() => {
        ...
        const flowerColorTuples = [
            ["#93C572", "#FFE5B4"], // light olive green, pale peach
        ];
    ...
    return (
        <div className={styles.container}>
            ...
            >
                ...
                {!isHelpMinimized && (
                    <ul className={styles.instructions}>
                        with a mouse or trackpad, play this scene,<br />
                        as <i><b>the worm</b></i> you trail, a path serene<br />
                        <i><b>the roots</b></i> they grow and seek to spread,<br />
                        but die of poison if met with <i><b> red</b></i> <br />
                        left click to drop some <i><b>green</b></i> in flight,<br />
                        for <i><b>the roots</b></i> to eat and grow in might<br />
                        <i><b>the worm</b></i> can eat a whole lotta red,<br />
                        and help <i><b>the roots</b></i> bloom a flower bed <br /> <br />
                        ...and if <i><b>the worm</b></i> or <i><b>the roots</b></i> get caged, <br />
            ...
            >
                ...
                {!isRefsMinimized && (
                    <ul className={styles.instructions}>
                        <li>i got the flowers from <a target="_blank" href="https://www.instagram.com/khyatitrehan/"> @khyatitrehan's</a> <a target="_blank" href="https://gemini.google.com/share/2ff8591725da"> demo</a></li>
                        <li>the roots grow using <a target="_blank" href="https://en.wikipedia.org/wiki/Prim%27s_algorithm"> prim's algorithm</a> </li>
                    </ul>
                )}
            </div>
