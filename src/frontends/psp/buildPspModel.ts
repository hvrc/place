  ...
  const categories: MenuCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          note: {
            actions: [
              { label: "Open", target: "/resume" },
              { label: "Download", target: "/files/resume.pdf", download: true, accent: true },
            ],
          },
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        { id: "sensitivity", label: "Scroll sensitivity", icon: "g:swipe_vertical", setting: "sensitivity" },
      ],
    },
  ];
